...
@section('title', 'Ошибка сервера - Librain')
...
@section('content')
    <div class="container d-flex flex-column align-items-center justify-content-center py-5 min-vh-75 animate-fade-in-up">
        <div class="text-center mb-5">
            <h1 class="display-1 fw-bold text-white mb-0"
                style="font-size: 8rem; text-shadow: 0 0 50px rgba(16, 185, 129, 0.3);">500</h1>
            <h2 class="display-5 fw-bold text-white mb-4">Ошибка на сервере</h2>
            <p class="lead text-muted mb-5 mx-auto" style="max-width: 600px;">
                Что-то пошло не так. Мы уже работаем над исправлением ошибки, попробуйте повторить попытку позже.
            </p>
    ...
    <style>
        ...
        .shadow-glow {
            ...
            /* Green glow for success/500? Use same teal/cyan if preferred or change */
